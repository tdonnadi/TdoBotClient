...
module.exports = "<ul class=\"msgs\" #chatMsgs>\n  <li class=\"bot\">\n  Bonjour,  interrogez-moi sur les programmes Télé du jour !\n  </li>\n  <li\n    *ngFor=\"let input of msgs\"\n    [ngClass]=\"{'user': input.type === 'user', 'bot': input.type === 'bot'}\"\n  >{{ input.msg }}</li>\n  <li class=\"bot\" *ngIf=\"botIsTyping\">\n    <span>.</span>\n    <span>.</span>\n    <span>.</span>\n  </li>\n</ul>\n\n<div class=\"chat-input\">\n  <form (submit)=\"onSubmit()\">\n    <input [(ngModel)]=\"userMsg\" name=\"userMsg\" class=\"chat-input-text\" type=\"text\" placeholder=\"Que voulez vous savoir...?\">\n  </form>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__speak_js__ = __webpack_require__("../../../../../src/app/speak.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_moment_timezone__ = __webpack_require__("../../../../moment-timezone/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_moment_timezone___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_17_moment_timezone__);
...
var AppComponent = (function () {
    function AppComponent(bodyEl) {
        ...
        this.timezone = __WEBPACK_IMPORTED_MODULE_16_moment__["tz"].guess();
        this.userMsg = '';
        this.msgs = [];
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.ws$.takeUntil(this.ngUnsubscribe$)
            ...
            _this.pushMsg(msg);
            console.log(msg.msg);
            Object(__WEBPACK_IMPORTED_MODULE_15__speak_js__["a" /* speak */])(msg.msg);
        });
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])('chatMsgs'),
